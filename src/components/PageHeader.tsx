...
/** iPhone-first Seitenkopf: Zurück (→ Startseite) · Titel · (Aktion). */
export default function PageHeader({ title, back = '/start', action }: { title: string; back?: string; action?: ReactNode }) {
  return (
