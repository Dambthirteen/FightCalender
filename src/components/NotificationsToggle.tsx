...
export default function NotificationsToggle() {
  ...
  const [prefs, setPrefs] = useState({ class_reminders: true, court_open: true, court_result: true, bitch_reminders: true, coach_reminders: true, chat_pushes: true });
  ...
  async function togglePref(key: 'class_reminders' | 'court_open' | 'court_result' | 'bitch_reminders' | 'coach_reminders' | 'chat_pushes') {
          ...
          {!subscribed ? (
            ...
            <>
              <div className="space-y-1.5">
                {([['class_reminders', 'Kurs-Erinnerungen (2 Std vorher)'], ['chat_pushes', 'Neue Chat-Nachrichten'], ['coach_reminders', 'Coach: dein Kurs startet bald'], ['bitch_reminders', 'Verpasst- & Ausrede-Erinnerungen'], ['court_open', 'Ausreden-Gericht geöffnet'], ['court_result', 'Gericht-Ergebnis']] as const).map(([key, label]) => (
