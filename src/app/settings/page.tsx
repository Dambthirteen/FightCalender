  ...
  return (
    <div className="min-h-screen text-[var(--text)]">
      ...
      <main className="max-w-md mx-auto px-4 pb-28 space-y-5">
        <div className="anim-up"><AccountSettings /></div>
        <div className="anim-up" style={{ animationDelay: '30ms' }}><ProfileVisibility /></div>
        ...
        <div className="anim-up" style={{ animationDelay: '120ms' }}>
          <div className="card p-5">
            ...
            <div className="space-y-1.5 text-sm">
              <a href="/meine-daten" className="block text-[var(--muted)] hover:text-white transition-colors">Meine Daten (Export / Konto löschen) ›</a>
